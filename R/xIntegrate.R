...
#' @author rstatistics
#' @export
xIntegrate <- function(x="/home/scrna/Lung/Pathogen-Track/scNSCLC/SampleInfo.txt", min.nFeature=500, max.nFeature=4000,
  ...
  for (sample in SampleInfo$sample){
    ...
    suppressMessages(objectList[[sample]] <- xReadTenX(sample=sample, path=SamplePathDict[[sample]], project=sample, column=GeneColumnDict[[sample]],
